const Article = () => {
	...
	return (
        <article className="hover:bg-gray-800 transition duration-350 ease-in-out">
                                <div className="flex flex-shrink-0 p-4 pb-1">
                                        ...
                                        <div className="flex items-center">
                                            ...
                                            <div className="ml-3">
                                                <p className="text-base leading-6 font-medium text-white pr-1">
                                                    Sonali Hirave
                                                    <span className="text-sm flex items-center flex-col md:flex-row leading-5 font-medium text-gray-400 group-hover:text-gray-300 transition ease-in-out duration-150">
                                ...
                                <div className="pl-0">
                                    ...
                                    <div className="md:flex-shrink pt-3">
                                        <div className="bg-cover bg-no-repeat bg-center w-full h-64" style={{height: "200px", backgroundImage: "url(https://images.unsplash.com/photo-1556740738-b6a63e27c4df?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=crop&amp;w=448&amp;q=80);"}}>
