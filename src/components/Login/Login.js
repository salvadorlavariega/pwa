...
export default function Login(props) {
	useEffect(() => {
		console.log('En login.useEffect')
		//checkUser()
	}, [])
	...
	return (
		<>
			<div>
					...
					<div className='btn-wrapper text-center'>
						<button
							...
							onClick={
								...
								() => console.log('Intenta login con facebook')
							}
						>
							<img
								alt='...'
						...
						<button
							...
							onClick={
								...
								() => console.log('Intenta login con Google')
							}
						>
							<img
								alt='...'
				...
				<p className='mt-2 text-center text-sm'>Or sign in with credentials </p>
			</div>
